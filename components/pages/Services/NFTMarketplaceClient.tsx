  ...
  const featureCards = [
    {
      ...
      desc: 'Secure and self-executing contracts for NFT minting, trading, royalties, and bidding.',
    },
    {
      title: 'IPFS & Metadata Storage',
      desc: 'Decentralized storage of NFT metadata and digital assets using IPFS.',
    },
    {
      title: 'Multi-Wallet Integration',
      desc: 'Support wallets like MetaMask, Trust Wallet, WalletConnect, and more.',
    },
    {
      title: 'Creator Royalties',
      desc: 'Automated royalty distribution to creators on secondary sales.',
    },
    {
      title: 'Multi-Chain Compatibility',
      desc: 'Built on Ethereum, BNB Chain, Polygon, Solana, Avalanche, and others.',
    },
    {
      title: 'Advanced Search & Filters',
      desc: 'Help users discover NFTs by category, creator, rarity, or price.',
    },
  ];
  ...
  const industryCards = [
    {
      ...
      desc: 'Empowering digital artists and collectors to tokenize rare artwork.',
    },
    {
      title: 'Gaming',
      desc: 'Enabling in-game item trading, weapon skins, avatars, and more.',
    },
    {
      title: 'Fashion & Luxury',
      desc: 'Authenticating luxury items with digital twins and NFT wearables.',
    },
    {
      title: 'Real Estate',
      desc: 'Tokenizing virtual properties and land parcels inside the Metaverse.',
    },
    {
      title: 'Music & Entertainment',
      desc: 'Letting musicians mint exclusive tracks, albums, and fan NFTs.',
    },
    {
      title: 'Sports & Media',
      desc: 'Launching fan tokens, digital trading cards, and event-based collectibles.',
    },
  ];

  const whyChoosePoints = [
    'Experience in building NFT platforms for web3 startups and enterprises',
    'Full-stack blockchain developers with cross-chain expertise',
    'In-house UI/UX design team for intuitive NFT marketplace experience',
    'Smart contract audits for maximum platform security',
    'Agile development with support, upgrades, and scalability',
  ];
        ...
        <main className="w-full pt-[90px] lg:pt-[125px]">
          ...
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[115px] pt-8 pb-6">
            <div className="w-full">
              ...
              >
                Build your custom NFT platform with <strong className="font-bold">DesignDot</strong>, the leading NFT marketplace development company. We help creators, brands, and businesses tokenize their assets and enable smooth trading of NFTs with smart contract automation and Metaverse-ready features.
              </p>
            </div>
          </div>
          ...
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[111px] pb-8">
            <div className="w-full pt-2">
              ...
              >
                Step into the future of digital ownership with our next-gen NFT marketplace solutions. Whether it&apos;s virtual real estate, gaming items, art, music, or fashion – we help you launch a fully functional, scalable, and immersive NFT marketplace with Metaverse compatibility and cross-chain integration.
              </p>
            </div>
          </div>

          {/* KEY FEATURES OF OUR NFT MARKETPLACE SOLUTIONS */}
          ...
          {/* INDUSTRIES EMBRACING NFT MARKETPLACES */}
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[111px] pb-14">
            <div className="w-full">
              <h2
                className="text-[#1a1a1a] uppercase mb-8 text-[20px] sm:text-[22px] md:text-[24px] font-bold"
          ...
          {/* WHY CHOOSE DESIGNDOT AS YOUR NFT DEVELOPMENT PARTNER? */}
