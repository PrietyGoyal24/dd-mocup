...
export default function SocialMediaMarketingClient() {
  const expertiseCards = [
    {
      ...
      desc: 'We optimize individual product titles, meta tags, descriptions, and images to improve rankings and increase click-through rates.',
    },
    {
      title: 'Technical SEO for eCommerce',
      desc: 'From site speed improvements to crawl efficiency, we ensure your website architecture is optimized for both search engines and users.',
    },
    {
      title: 'Category & Collection Page SEO',
      desc: 'Well-structured category pages help users find products easily and are crucial for keyword targeting and internal linking.',
    },
    {
      title: 'Schema Markup Integration',
      desc: 'We implement structured data for products, reviews, and pricing to enhance visibility in search results with rich snippets.',
    },
    {
      title: 'Mobile & Core Web Vitals Optimization',
      desc: 'Ensure fast load times and seamless mobile shopping experience to boost rankings and reduce bounce rates.',
    },
    {
      title: 'Multilingual & International SEO',
      desc: 'Expand your reach across regions with geo-targeted content, hreflang implementation, and international URL structures.',
    },
  ];
  ...
  const whyChooseCards = [
    {
      ...
      desc: 'We work with all major platforms like Shopify, WooCommerce, Magento, BigCommerce, and custom eCommerce solutions.',
    },
    {
      title: 'Data-Driven Strategy',
      desc: 'Our SEO decisions are backed by keyword research, competitor analysis, and performance metrics that matter.',
    },
    {
      title: 'Content That Converts',
      desc: 'We create SEO-friendly product descriptions and blog content that improves rankings and persuades users to buy.',
    },
    {
      title: 'ROI-Focused Approach',
      desc: 'Our goal isn’t just traffic—it’s conversions. We help turn more visitors into paying customers with smart SEO strategies.',
    },
  ];
  ...
  const toolsList = [
    ...
    'Schema.org, JSON-LD',
    'Shopify SEO Tools, Magento SEO Extensions',
        ...
        <main className="w-full pt-[90px] lg:pt-[125px]">
          ...
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[115px] pt-8 pb-6">
            <div className="w-full">
              ...
              >
                In today&apos;s competitive online marketplace, generic SEO just isn&apos;t enough. Our Specialized eCommerce SEO services are tailored to meet the unique needs of online retailers, helping you drive targeted traffic, improve product visibility, and increase conversion rates. From optimizing thousands of product pages to implementing structured data and improving site architecture, we help your eCommerce site perform better on search engines.
              </p>
            </div>
          </div>
          ...
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[111px] pb-12">
            <div className="w-full overflow-hidden">
              <img
                ...
                alt="Social Media Marketing / Specialized ECommerce SEO"
          ...
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[111px] pb-16">
            <div className="w-full">
              ...
              >
                eCommerce SEO isn&apos;t just about getting found—it&apos;s about getting chosen. Let us optimize your online store to improve visibility, attract high-intent buyers, and grow your revenue.
              </p>
            </div>
          </div>
        </main>
