...
export default function MarketingAndAdvertisingClient() {
  const serviceCards = [
    {
      title: 'Brand Strategy',
      desc: 'Develop a strong brand identity and positioning that resonates with your audience.',
    },
    {
      title: 'Search Engine Optimization (SEO)',
      desc: 'Improve your visibility on search engines with on-page and off-page optimization.',
    },
    {
      title: 'Social Media Marketing',
      desc: 'Engage your audience and build a community across platforms like Instagram, Facebook, and LinkedIn.',
    },
    {
      title: 'Pay-Per-Click Advertising (PPC)',
      desc: 'Generate quick and qualified leads through Google Ads, Bing Ads, and paid social campaigns.',
    },
    {
      title: 'Email Marketing',
      desc: 'Drive repeat engagement and sales through targeted and automated email campaigns.',
    },
    {
      title: 'Content Marketing',
      desc: 'Create high-quality blog posts, infographics, videos, and guides to educate and attract your audience.',
    },
    {
      title: 'Influencer Marketing',
      desc: 'Partner with key influencers to promote your products and build trust with niche communities.',
    },
    {
      title: 'Video Production',
      desc: 'Tell your brand story through professional video ads, explainer videos, and reels.',
    },
  ];

  const whyChoosePoints = [
    'Data-driven campaign execution',
    'Customized strategies for B2B & B2C',
        ...
        <main className="w-full pt-[90px] lg:pt-[125px]">
          ...
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[115px] pt-8 pb-6">
            <div className="w-full">
              ...
              >
                Transform your business with our strategic marketing and advertising services tailored to build brand awareness, attract targeted traffic, and convert leads into customers. Whether you&apos;re a startup or an enterprise, we help you amplify your voice in the digital landscape.
              </p>
            </div>
          </div>
          ...
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[111px] pb-12">
            <div className="w-full overflow-hidden">
              <img
                ...
                alt="Marketing & Advertising Services"
          ...
          {/* OUR CORE MARKETING & ADVERTISING SERVICES */}
          ...
          {/* LET'S BUILD A WINNING MARKETING STRATEGY */}
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[111px] pb-16">
            <div className="w-full">
              ...
              >
                Our team of experts is ready to craft a performance-driven marketing campaign tailored to your business goals. Let&apos;s take your brand to new heights.
              </p>
            </div>
          </div>
        </main>
