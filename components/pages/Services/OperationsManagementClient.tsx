...
export default function OperationsManagementClient() {
  ...
  const keyBenefitsCards = [
    {
      ...
      desc: 'Automate routine operations and reduce manual effort across departments.',
    },
    {
      title: 'Data Visibility',
      desc: 'Gain insights into your operations with real-time dashboards and analytics.',
    },
    {
      title: 'Scalable Systems',
      desc: 'Implement scalable frameworks that grow with your business requirements.',
    },
    {
      title: 'Cost Optimization',
      desc: 'Identify areas of cost leakage and implement strategies for savings.',
    },
    {
      title: 'Process Standardization',
      desc: 'Ensure consistency and quality across all operational workflows.',
    },
    {
      title: 'Agile Execution',
      desc: 'Quickly adapt to market changes with flexible and modular solutions.',
    },
  ];
        ...
        <main className="w-full pt-[90px] lg:pt-[125px]">
          ...
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[115px] pt-8 pb-6">
            <div className="w-full">
              ...
              >
                Our operations management solutions are designed to help businesses streamline workflows, automate repetitive tasks, and optimize resources. From production and supply chain to workforce and technology processes, we enable efficient and scalable operations.
              </p>
            </div>
          </div>
          ...
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[111px] pb-12">
            <div className="w-full pt-2">
              ...
              <ul className="space-y-2.5 ml-2">
                {comprehensiveServices.map((item, index) => (
          ...
          {/* KEY BENEFITS OF OUR OPERATIONS MANAGEMENT SOLUTIONS */}
          ...
          <div className="w-full px-6 lg:pl-[104px] lg:pr-[111px] pb-16">
            <div className="w-full">
              ...
              >
                Whether you are looking to revamp existing workflows or build a new operational strategy, our team can provide the tools and expertise to transform your business processes into efficient, reliable, and future-ready operations.
              </p>
            </div>
          </div>
        </main>
