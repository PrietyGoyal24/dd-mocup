          ...
          <div className="flex items-center flex-1">
            ...
            <div className="flex items-baseline">
              <h2 className="font-bold text-[22px] lg:text-[26px] leading-none tracking-tight text-black m-0 p-0" style={{ fontFamily: "'GTWalsheimPro-Bold'" }}>
                Blog<span className="inline-block w-[6px] h-[6px] lg:w-[8px] lg:h-[8px] bg-black rounded-full ml-[4px] relative -top-[2px]"></span>
              </h2>
            </div>
          </div>
        ...
        <div className="w-full pl-0 md:pl-[120px] lg:pl-[160px]">
          ...
          <div className="flex flex-col text-left mb-[30px] lg:mb-[40px]">
            <p className="text-[16px] lg:text-[18px] leading-[1.8] text-black" style={{ fontFamily: "'GTWalsheimPro-Regular'" }}>
              <strong className="tracking-wide font-bold" style={{ fontFamily: "'GTWalsheimPro-Bold'" }}>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 p-6 lg:p-8">
                    <div className="text-[32px] lg:text-[40px] leading-none text-white/80" style={{ fontFamily: "'GTWalsheimPro-Regular'" }}>
                      {day}
                    </div>
                    <div className="text-[12px] lg:text-[14px] text-white/60 tracking-wide mt-2" style={{ fontFamily: "'GTWalsheimPro-Regular'" }}>
                      {monthYear}
                    </div>
                  </div>
                  ...
                  <div className="relative z-10 p-6 lg:p-8 flex flex-col gap-4">
                    <h3 className="text-[18px] lg:text-[20px] leading-[1.4] text-white/90" style={{ fontFamily: "'GTWalsheimPro-Regular'" }}>
                      {post.title}
                    </h3>
